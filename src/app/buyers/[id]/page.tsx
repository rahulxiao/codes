...
export default function BuyerDetail({ params }: BuyerDetailProps) {
  const buyer = dummyBuyers.find(b => b.id === params.id);
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full">
          <div className="bg-white py-8 px-6 shadow-xl rounded-2xl border border-gray-100 text-center">
            ...
            <p className="text-gray-600 mb-8">The buyer with ID {params.id} does not exist.</p>
            <a 
              href="/buyers" 
